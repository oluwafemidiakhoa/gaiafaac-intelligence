...
**Nigeria's Federation Account allocations, verified and traceable.**

GaiaFAAC Intelligence is an independent public-finance research platform that turns Nigerian Federation Account Allocation Committee records into source-linked data, comparisons, and analytics. It is **not an official government platform**.

The platform now publishes real, human-approved FAAC records extracted from Office of the Accountant-General of the Federation source documents. Every published month preserves its source URL, document metadata, and SHA-256 fingerprint.

## Live product

Live application:

- https://gaiafaac-api-production.up.railway.app/live
...
The latest verified month remains publicly accessible. Paid plans are intended to unlock historical data, exports, reports, team access, and API use. Automated checkout, customer accounts, personalized licensed exports, and subscription self-service are not yet complete and must not be represented as available until they are implemented.
...
- Demo, pending, rejected, and unpublished records are excluded from live-data endpoints.
...
- Statistical warnings are not treated as evidence of fraud or misconduct.
...
/methodology       Collection, validation, and publication methodology
/pricing           Public plan positioning
/pilot             Pilot-access and partnership enquiry
```
