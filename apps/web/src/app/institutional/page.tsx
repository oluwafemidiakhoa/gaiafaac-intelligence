    ...
    <div className="pb-8">
          ...
          <div>
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              ...
              <Button
                ...
                size="lg"
                variant="outline"
                className="rounded-full border-white/15 bg-white/[0.04] text-white hover:bg-white/[0.08] hover:text-white"
              >
      ...
      <div className="gaia-shell gaia-section">
        <section className="grid gap-8 lg:grid-cols-[.72fr_1.28fr] lg:items-start">
          <div>
            ...
            <p className="text-muted-foreground mt-5 text-base leading-8">
              ...
              and tax evidence can be public while still being costly to
              collect, reconcile, monitor and defend inside a serious
              institution.
            </p>
          </div>
          ...
          <div className="grid gap-4 md:grid-cols-3">
            {useCases.map(({ icon: Icon, title, description }) => (
              <article
                key={title}
                className="gaia-panel group p-6 transition hover:-translate-y-1"
              >
          ...
          <div className="grid lg:grid-cols-[.8fr_1.2fr]">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3">
              {evidenceModel.map((item, index) => (
                <div
                  key={item}
                  className="border-t border-white/10 p-6 first:border-t-0 sm:border-l sm:first:border-l-0 lg:[&:nth-child(-n+3)]:border-t-0"
                >
                  <p className="font-mono text-xs font-semibold text-amber-300">
                    0{index + 1}
                  </p>
                  <p className="mt-7 text-sm leading-6 font-medium text-white/75">
                    {item}
                  </p>
                </div>
              ))}
        ...
        <section className="mt-12 grid gap-5 lg:grid-cols-2">
          ...
          <div className="overflow-hidden rounded-3xl border border-amber-300/40 bg-amber-100/60 p-7 sm:p-8 dark:bg-amber-300/[0.07]">
            ...
            <p className="text-muted-foreground mt-4 text-sm leading-7">
              ...
              registry, the review protocol and an answer that can be traced
            ...
            <div className="mt-7 flex flex-wrap gap-2">
              ...
              <Button asChild variant="outline">
                <Link href="/review">See review controls</Link>
              </Button>
            </div>
          </div>
        </section>
