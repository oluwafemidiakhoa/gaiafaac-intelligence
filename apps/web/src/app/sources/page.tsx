...
export default async function SourcesPage() {
  ...
  const evidenceNetworkResult = await getEvidenceNetworkStatus({
    oagfLive: Boolean(latestJurisdiction) && latestCoverageComplete === true,
    oagfPeriod: latestJurisdiction?.revenue_month ?? null,
  })
  const evidenceLanes = evidenceNetworkResult.data ?? []
  ...
  return (
    <div className="mx-auto max-w-7xl px-5 py-12 lg:px-8 lg:py-16">
      ...
      <section className="mt-12" aria-labelledby="source-lanes">
        ...
        {evidenceNetworkResult.error || evidenceLanes.length === 0 ? (
          <DataUnavailable
            message={
