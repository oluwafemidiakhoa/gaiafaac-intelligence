  ...
  if (!result.data) {
    return (
      <div className="gaia-shell py-12 lg:py-16">
        ...
        />
        <div className="mt-8">
          <DataUnavailable message={result.error ?? 'Fiscal Receipt unavailable.'} />
        </div>
      </div>
    )
  }
    ...
    <div className="gaia-shell py-12 lg:py-16">
        ...
        <Card>
          <CardHeader>
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <CardDescription>
                  SHA-256 of the canonical private evidence manifest recorded by Gaia.
                </CardDescription>
              </div>
            </div>
          </CardHeader>
          <CardContent className="space-y-5">
            ...
            <div>
              ...
              <p className="mt-1 font-mono text-sm break-all">{receipt.receipt_sha256}</p>
            </div>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                <p className="text-xs text-muted-foreground">Source fingerprints</p>
                <p className="mt-1 font-mono text-2xl font-semibold">
      ...
      <Card className="mt-5">
        <CardHeader>
          ...
          <CardDescription>
            These hashes identify the captured evidence records without exposing private organization notes or the internal decision question.
          </CardDescription>
        </CardHeader>
        <CardContent>
      ...
      <Card className="mt-5">
        <CardHeader>
          <div className="flex items-start gap-3">
            <CheckCircle2 className="mt-0.5 size-5 text-amber-700" aria-hidden="true" />
            <div>
              <CardTitle>Verification boundary</CardTitle>
              <CardDescription>
                A Fiscal Receipt is an evidence receipt, not a rating, recommendation, government certification or investment opinion.
              </CardDescription>
            </div>
          </div>
        </CardHeader>
