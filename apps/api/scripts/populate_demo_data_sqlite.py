...
def main() -> None:
    ...
    with SessionLocal() as session:
        ...
        state_names = [
            "Lagos", "Kano", "Katsina", "Oyo", "Rivers", "Bauchi", "Jigawa",
            "Delta", "Kebbi", "Borno", "Enugu", "Ebonyi", "Anambra", "Imo",
            "Abia", "Akwa Ibom", "Cross River", "Edo", "Ekiti", "Osun",
            "Ondo", "Ogun", "Kwara", "Niger", "Plateau", "Taraba", "Adamawa",
            "Gombe", "Yobe", "Zamfara", "Sokoto", "Nasarawa", "Kogi", "Kaduna",
            "Benue", "Abuja", "Bayelsa"
        ]
